...
const convertGoogleDriveLink = (shareableLink: string): string => {
  let fileId = '';
  ...
  return (
    ...
    >
      <div className="h-48 bg-gray-200 relative">
        <Image
          src={convertGoogleDriveLink(event.images[0])}
          alt={event.title}
          fill
              ...
              <div className="relative">
                <div className="relative w-full h-[500px] bg-gray-100">
                  <AnimatePresence mode="wait">
                    ...
                    >
                      <Image
                        src={convertGoogleDriveLink(selectedEvent.images[currentIndex])}
